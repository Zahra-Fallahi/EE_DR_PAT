...
# start the measure
class CoolingSetpointsHourlyAdjustedByDegrees1 < OpenStudio::Measure::ModelMeasure
  # human readable name
  def name
    return "CoolingSetpointsHourlyAdjustedByDegrees1"
  end
...
CoolingSetpointsHourlyAdjustedByDegrees1.new.registerWithApplication
